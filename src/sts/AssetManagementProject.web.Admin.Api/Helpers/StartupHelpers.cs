...
using AssetManagementProject.web.Admin.Api.AuditLogging;
using AssetManagementProject.web.Admin.Api.Configuration;
using AssetManagementProject.web.Admin.Api.Configuration.ApplicationParts;
...
namespace AssetManagementProject.web.Admin.Api.Helpers
{
