...
using AssetManagementProject.web.STS.Identity.Configuration.ApplicationParts;
using AssetManagementProject.web.STS.Identity.Configuration.Constants;
...
namespace AssetManagementProject.web.STS.Identity.Helpers
{
    public static class StartupHelpers
    {
            ...
            IConfiguration configuration)
        {
            ...
            {
                authenticationBuilder.AddOpenIdConnect("aad", "Azure AD", options =>
                {
                    options.SignInScheme = IdentityServerConstants.ExternalCookieAuthenticationScheme;
                    options.SignOutScheme = IdentityServerConstants.SignoutScheme;
                    options.Authority = $"https://login.windows.net/{externalProviderConfiguration.AzureAdTenantId}";
