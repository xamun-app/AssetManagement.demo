...
using AssetManagementProject.web.STS.Identity.Configuration;
using AssetManagementProject.web.STS.Identity.Helpers;
using AssetManagementProject.web.STS.Identity.Helpers.Localization;
using AssetManagementProject.web.STS.Identity.ViewModels.Account;
using Microsoft.Extensions.Configuration;
using AssetManagementProject.web.Admin.EntityFramework.Shared.Entities.Identity;
using System.Net.Http;
using IdentityModel.Client;
using Newtonsoft.Json;
using System.Collections.Generic;

namespace AssetManagementProject.web.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<IActionResult> MobileLogin([FromBody] MobileLoginInputModel model)
        {
            ...
            if (user != default(UserIdentity))
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string baseUrl = _configuration["AdminConfiguration:IdentityAdminSTSBaseUrl"];
                    ...
                    collection.Add(new("username", model.Username));
                    collection.Add(new("password", model.Password));
                    collection.Add(new("client_id", "catalyst_mobile"));
                    collection.Add(new("client_secret", "Bl@st123"));
                    collection.Add(new("scope[]", "BlastAsiaCatalyst_api"));
                    collection.Add(new("scope[]", "CatalystAdminClient_api"));
                    collection.Add(new("scope[]", "offline_access"));
                    ...
                    var responseJsonString = await requestResult.Content.ReadAsStringAsync();
                    var mobileLoginResponse = JsonConvert.DeserializeObject<MobileLoginResponseViewModel>(responseJsonString);

                    return Ok(mobileLoginResponse);
                }
        ...
        public async Task<IActionResult> RefreshToken([FromBody] string refreshToken)
        {
            try
            {
                ...
                string baseURL = _configuration.GetValue<string>("AdminConfiguration:IdentityAdminSTSBaseURL");
                ...
                var mobileLoginResponse = JsonConvert.DeserializeObject<RefreshTokenViewModel>(tokenResponse.Raw);
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            if (context != null)
            {
                ...
                var email = OpenIdClaimHelpers.GetEmailAddressFromClaims(claims.ToList(), provider);
                ...
                return Redirect(_configuration["AdminConfiguration:ClientSpaUri"]);
            }
