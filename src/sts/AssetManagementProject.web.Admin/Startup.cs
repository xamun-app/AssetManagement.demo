...
using AssetManagementProject.web.Admin.Configuration.Database;
...
namespace AssetManagementProject.web.Admin
{
    public class Startup
    {
        ...
        {
            app.UsePathBase(Configuration["HttpConfiguration:BasePath"]);
            app.UseRouting();
