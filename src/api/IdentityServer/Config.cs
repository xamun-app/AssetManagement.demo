...
namespace IdentityServer
{
    public class Config
    {
        ...
        public static IEnumerable<ApiScope> GetApiScopes()
        {
            ...
            {
                new ApiScope(name: "read",   displayName: "Reads."),
                new ApiScope(name: "read-write",   displayName: "Writes.")
            };
        }
        public static IEnumerable<ApiResource> GetApiResources()
        {
            ...
            {
                new  ApiResource("AssetManagementProject.web", "My API"){
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new List<Client>
            {
                new Client
                {
                    ...
                    AllowedScopes = { "read", "read-write" }
                },
                new Client
                {
                    ClientId = "AssetManagementProject.webClient",
