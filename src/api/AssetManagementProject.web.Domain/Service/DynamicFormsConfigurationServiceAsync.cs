...
namespace AssetManagementProject.web.Domain.Service
{
    ...
    /// </summary>
    public class DynamicFormsConfigurationServiceAsync<Tv, Te> : GenericServiceAsync<Tv, Te>
                                        where Tv : DynamicFormsConfigurationViewModel
                                        where Te : DynamicFormsConfiguration
    {
        //DI must be implemented in specific service as well beside GenericService constructor
        public DynamicFormsConfigurationServiceAsync(IUnitOfWork unitOfWork, IMapper mapper)
        {
            if (_unitOfWork == null)
